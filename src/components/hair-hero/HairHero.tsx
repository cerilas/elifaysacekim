...
export const HERO_I18N: Record<Language, {
  ...
  tr: {
    ...
    profileAria: 'Saç ekim uzmanı Elif Ay ile tanışın',
  ...
  en: {
    ...
    profileAria: 'Meet Hair Transplant Specialist Elif Ay',
  ...
  ar: {
    ...
    profileAria: 'تعرف على أخصائية زراعة الشعر إليف آي',
  ...
  de: {
    ...
    profileAria: 'Lernen Sie Spezialistin Elif Ay kennen',
