...
export const TRANSLATIONS: Record<Language, Translations> = {
  tr: {
    ...
    bottomCtaDesc: "Saç veya kaş fotoğraflarınızı ileterek Saç Ekim Uzmanı Elif Ay'dan kişiselleştirilmiş greft planlaması hakkında 15 dakikada bilgi edinin.",
    bottomCtaBtn: 'Hemen Analiz Başlatın',

    readingTimeSuffix: 'dk okuma',
    articleAuthorLabel: 'Saç Ekim Uzmanı',
    articleShare: 'Paylaş',
  ...
  en: {
    ...
    expertTitle: 'Hair Transplant Specialist',
    ...
    bottomCtaDesc: 'Send your hair or eyebrow photos via WhatsApp to receive a personalized graft plan from Specialist Elif Ay within 15 minutes.',
    bottomCtaBtn: 'Start Free Analysis Now',

    readingTimeSuffix: 'min read',
    articleAuthorLabel: 'Hair Transplant Specialist',
    articleShare: 'Share',
  ...
  ar: {
    ...
    expertTitle: 'أخصائية زراعة الشعر',
    ...
    bottomCtaDesc: 'أرسل صور شعرك أو حاجبيك عبر الواتساب لتلقي خطة علاجية مخصصة وتحديد عدد البصيلات من الأخصائية إليف آي خلال 15 دقيقة.',
    bottomCtaBtn: 'ابدأ التحليل المجاني الآن',

    readingTimeSuffix: 'دقائق قراءة',
    articleAuthorLabel: 'أخصائية زراعة الشعر',
    articleShare: 'مشاركة',
  ...
  de: {
    ...
    navHome: 'Startseite',
    ctaAnalysis: 'Kostenlose Analyse ↗',
    ...
    expertTitle: 'Haartransplantations-Spezialistin',
    ...
    bottomCtaDesc: 'Senden Sie Ihre Fotos über WhatsApp, um innerhalb von 15 Minuten einen persönlichen Graft-Plan von Spezialistin Elif Ay zu erhalten.',
    bottomCtaBtn: 'Kostenlose Analyse starten',

    readingTimeSuffix: 'Min. Lesezeit',
    articleAuthorLabel: 'Haartransplantations-Spezialistin',
    articleShare: 'Teilen',
