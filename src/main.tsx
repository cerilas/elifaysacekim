...
const CARE_I18N = {
  tr: {
    ...
    waBtn: 'WhatsApp ile Ücretsiz Greft Analizi Başlatın ↗',
  ...
  en: {
    ...
    waBtn: 'Start Free Graft Analysis on WhatsApp ↗',
  ...
  ar: {
    ...
    waBtn: 'ابدأ تحليل البصيلات المجاني عبر واتساب ↗',
  ...
  de: {
    ...
    waBtn: 'Kostenlose Graft-Analyse per WhatsApp starten ↗',
