...
const SPECIALIST_I18N: Record<Language, {
  ...
  ar: {
    ...
    bio: 'بأكثر من 15 عاماً من الخبرة الطبية المتخصصة، تقدم منسقة ومستشارة زراعة الشعر إليف آي أعلى معايير الجودة في تقنيات السفير FUE وزراعة DHI واللحية والحواجب للنساء. توفر عيادتنا المركزية في غازي عنتاب سهولة الوصول لمرضانا من مختلف المدن والدول، مع ضمان رسم خط شعر طبيعي متناسق تماماً مع ملامح الوجه.',
  ...
  de: {
    ...
    bio: 'Mit mehr als 15 Jahren klinischer Erfahrung steht Haartransplantations-Koordinatorin & Beraterin Elif Ay für erstklassige Ergebnisse mit Saphir FUE, DHI Haartransplantation, Bart- und Augenbrauentransplantation für Frauen. Unsere zentral gelegene Klinik in Gaziantep bietet bequeme Anreise und individuelle, natürliche Haarlinien-Konzepte.',
    ...
    imageAlt: 'Haartransplantations-Koordinatorin & Beraterin Elif Ay - Klinik Gaziantep',
  },
};
