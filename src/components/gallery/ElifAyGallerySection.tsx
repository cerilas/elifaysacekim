...
export function ElifAyGallerySection({
  ...
  const headerI18n = {
    tr: {
      ...
      brandSub: 'ELİF AY - SAÇ EKİM KOORDİNATÖRÜ VE DANIŞMANI',
    ...
    en: {
      ...
      brandSub: 'ELİF AY - HAIR TRANSPLANT COORDINATOR & CONSULTANT',
    ...
    ar: {
      ...
      brandSub: 'إليف آي - منسقة ومستشارة زراعة الشعر',
    ...
    de: {
      ...
      brandSub: 'ELİF AY - HAARTRANSPLANTATIONS-KOORDINATORIN & BERATERIN',
