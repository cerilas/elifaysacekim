...
export const HERO_I18N: Record<Language, {
  ...
  tr: {
    ...
    profileAria: 'Saç Ekim Koordinatörü Elif Ay ile tanışın',
  ...
  en: {
    ...
    profileAria: 'Meet Hair Transplant Coordinator Elif Ay',
  ...
  ar: {
    ...
    profileAria: 'تعرف على منسقة زراعة الشعر إليف آي',
  ...
  de: {
    ...
    profileAria: 'Lernen Sie Haartransplantations-Koordinatorin Elif Ay kennen',
